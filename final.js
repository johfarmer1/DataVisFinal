...
var buildMap = function() {
  ...
  county
    ...
    .on('mouseover', function(d) {
                    ...
                    tip.html("County: " + county + "</br>" + "Population: " + pop + "</br>" + "District: " + district + "</br>" + "Total Votes: " + tVotes + "</br>" + "Democrat: " + (dem/tVotes*100).toFixed(2) + "%</br>" + "Republican: " + (rep/tVotes*100).toFixed(2) + "%</br>" + "Independent: " + (ind/tVotes*100).toFixed(2) +"%")
					tip.transition()
						.duration(200)
						.style('opacity', .9)
